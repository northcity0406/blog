<template>
  <div id="article-manage">
    ...
    <div class="article-table-wrap">
      <el-table :data="articleList" border stripe size="mini" style="width: 100%">
        ...
        <el-table-column prop="categoryName" label="分类" show-overflow-tooltip width="120"></el-table-column>
        <el-table-column prop="pageview" label="阅读量" width="60"></el-table-column>
        <el-table-column label="加密" width="45">
        ...
        <el-table-column prop="publishTime" label="发布时间" width="128" :formatter="formatTime"></el-table-column>
