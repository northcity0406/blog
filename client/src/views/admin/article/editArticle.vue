...
<div id="edit-article">
    ...
    <div class="edit-wrap">
        <mavon-editor class="editor" v-model="article.content" ref="md" @imgAdd="$imgAdd" :boxShadow="false" defaultOpen="edit" :toolbars="{
          bold: true, // 粗体
          italic: true, // 斜体
          header: true, // 标题
          underline: true, // 下划线
        ...
        <div class="input-wrap">
            <div class="fix-input-wrap">
                <UP class="upload-cover" :default-img="article.cover" ratio="2" WHRatio="2" maxWidth="300" maxHeight="150" tip="上传文章封面图" maxSize="2" @uploadSuccess="uploadSuccess"></UP>
                ...
                <div class="label-wrap">
                    ...
                    <el-select v-model="category" filterable allow-create default-first-option size="mini" placeholder="请选择文章分类">
                        <el-option v-for="item in categoryList" size="mini" :key="item.id" :label="item.name" :value="item.name"></el-option>
                    </el-select>
                </div>
                <div class="label-wrap">
                    标签：
                    <el-select v-model="tags" filterable allow-create default-first-option size="mini" multiple placeholder="请选择文章标签">
                        <el-option v-for="item in tagList" size="mini" :key="item.id" :label="item.name" :value="item.name"></el-option>
                    </el-select>
                </div>
            </div>
        </div>
